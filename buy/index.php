	...
	<div class="container">
		...
		<div id="navbar-collapse-02" class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="propClone"><a href="<?php echo base_url ?>/generallogic">General Logistics</a></li>
				...
				<div class="fadeshop">
					<div class="captionshop text-center" style="display: none;">
						...
						<p>
							...
							<a href="purchase/?buy=<?php  echo $data["id"] ?>" class="learn-more detailslearn"><i class="fa fa-link"></i>
														Details
													</a>
						</p>
					</div>
