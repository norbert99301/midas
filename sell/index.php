...
<body class="min-vh-100 d-flex flex-column">
        ...
        <div class="container">
            <nav class="navbar navbar-dark bg-transparenet">
                <a class="navbar-brand" href="#">
                    <!-- <img src="assets/images/midaslogo.svg" alt="logo" style="width:75px; height: 75px;"> -->
                </a>
    ...
    <main class="my-auto">
        <div class="container">
            <h1 style="text-align: center;" class="page-title">Coming soon...</h1>
            <br> <br>
            <div align="center"><a href="<?php echo base_url ?>">Back Home</a></div>
